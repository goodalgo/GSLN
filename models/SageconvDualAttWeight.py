...
# cp sageconv_mc.py /home/pai/lib/python3.6/site-packages/dgl/nn/pytorch/conv/
import torch
...
#         self.fc_neigh = nn.Linear(self._in_src_feats, out_feats)
        ...
        self.feat_attn_W = nn.Parameter(torch.FloatTensor(size=(1, self.num_heads, self._out_feats)))  #第二个self._in_src_feats可以随便写  
